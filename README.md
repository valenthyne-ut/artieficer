...
As of v0.1.2, Artieficer looks in the *clients/root* directory for any valid clients, lists how many it found and executes them all (if they're enabled in their configuration).